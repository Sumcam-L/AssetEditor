...
internal class VS2005DockPaneStrip : DockPaneStripBase
{
	...
	private Rectangle TabsRectangle
	{
		get
		{
			...
			num3 -= DocumentTabGapLeft + DocumentTabGapRight + DocumentButtonGapRight + ButtonClose.Width + ButtonWindowList.Width + 2 * DocumentButtonGapBetween;
	...
	{
		return Math.Max(TextFont.Height + DocumentTabGapTop + ((PatchController.EnableHighDpi == true) ? DocumentIconGapBottom : 0), ButtonClose.Height + DocumentButtonGapTop + DocumentButtonGapBottom) + DocumentStripGapBottom + DocumentStripGapTop;
	}

	protected override void OnPaint(PaintEventArgs e)
	{
		Rectangle tabsRectangle = TabsRectangle;
		DockPanelGradient dockStripGradient = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.DockStripGradient;
		if (base.Appearance == DockPane.AppearanceStyle.Document)
		{
		...
		{
			dockStripGradient = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.DockStripGradient;
		}
		Color startColor = dockStripGradient.StartColor;
		Color endColor = dockStripGradient.EndColor;
		LinearGradientMode linearGradientMode = dockStripGradient.LinearGradientMode;
		DrawingRoutines.SafelyDrawLinearGradient(tabsRectangle, startColor, endColor, linearGradientMode, e.Graphics);
		base.OnPaint(e);
		CalculateTabs();
	...
	private void CalculateTabs_Document()
	{
		...
		{
			int num2 = num;
			(base.Tabs[m_startDisplayingTab] as TabVS2005).MaxWidth = GetMaxTabWidth(m_startDisplayingTab);
	...
	private bool EnsureDocumentTabVisible(IDockContent content, bool repaint)
	{
		...
		if ((base.Tabs[num] as TabVS2005).TabWidth != 0)
		{
			return false;
		}
	...
	private void DrawTab_ToolWindow(Graphics g, TabVS2005 tab, Rectangle rect)
	{
		...
		{
			Color startColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.StartColor;
			Color endColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.EndColor;
			LinearGradientMode linearGradientMode = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.LinearGradientMode;
			...
			Color textColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.TextColor;
			TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectangle2, textColor, ToolWindowTextFormat);
		}
		else
		{
			Color startColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.StartColor;
			Color endColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.EndColor;
			LinearGradientMode linearGradientMode2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.LinearGradientMode;
			g.FillPath(new LinearGradientBrush(rect2, startColor2, endColor2, linearGradientMode2), tabOutline);
			if (base.Tabs.IndexOf(base.DockPane.ActiveContent) != base.Tabs.IndexOf(tab) + 1)
			{
				...
				g.DrawLine(pt2: DrawHelper.RtlTransform(this, new Point(rect.Right, rect.Bottom - ToolWindowTabSeperatorGapBottom)), pen: PenToolWindowTabBorder, pt1: DrawHelper.RtlTransform(this, point));
			}
			Color textColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.TextColor;
			TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectangle2, textColor2, ToolWindowTextFormat);
		}
	...
	private void DrawTab_Document(Graphics g, TabVS2005 tab, Rectangle rect)
	{
		...
		Rectangle rect2 = DrawHelper.RtlTransform(this, rect);
		rect2.Width += DocumentIconGapLeft;
		rect2.X -= DocumentIconGapLeft;
		rectangle2 = DrawHelper.RtlTransform(this, rectangle2);
		rectangle = DrawHelper.RtlTransform(this, rectangle);
		GraphicsPath tabOutline = GetTabOutline(tab, rtlTransform: true, toScreen: false);
		if (base.DockPane.ActiveContent == tab.Content)
		{
			Color startColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.StartColor;
			Color endColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.EndColor;
			LinearGradientMode linearGradientMode = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.LinearGradientMode;
			g.FillPath(new LinearGradientBrush(rect2, startColor, endColor, linearGradientMode), tabOutline);
			g.DrawPath(PenDocumentTabActiveBorder, tabOutline);
			Color textColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.ActiveTabGradient.TextColor;
		...
		{
			Color startColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.StartColor;
			Color endColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.EndColor;
			LinearGradientMode linearGradientMode2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.LinearGradientMode;
			g.FillPath(new LinearGradientBrush(rect2, startColor2, endColor2, linearGradientMode2), tabOutline);
			g.DrawPath(PenDocumentTabInactiveBorder, tabOutline);
			Color textColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.DocumentGradient.InactiveTabGradient.TextColor;
			TextRenderer.DrawText(g, tab.Content.DockHandler.TabText, TextFont, rectangle2, textColor2, DocumentTextFormat);
		}
	...
	private void SetInertButtons()
	{
		...
		{
			ButtonClose.Enabled = base.DockPane.ActiveContent == null || base.DockPane.ActiveContent.DockHandler.CloseButton;
