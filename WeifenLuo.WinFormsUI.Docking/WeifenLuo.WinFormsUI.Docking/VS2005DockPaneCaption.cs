...
internal class VS2005DockPaneCaption : DockPaneCaptionBase
{
	...
	private static Blend ActiveBackColorGradientBlend
	{
		get
		{
			if (_activeBackColorGradientBlend == null)
			{
				...
				blend.Factors = new float[2] { 0.5f, 1f };
	...
	private Color TextColor
	{
		get
		{
			...
			{
				return base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.TextColor;
			}
			return base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.TextColor;
		}
	}
	...
	private void DrawCaption(Graphics g)
	{
		...
		if (base.DockPane.IsActivated)
		{
			Color startColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.StartColor;
			Color endColor = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.EndColor;
			LinearGradientMode linearGradientMode = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.LinearGradientMode;
		...
		{
			Color startColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.StartColor;
			Color endColor2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.EndColor;
			LinearGradientMode linearGradientMode2 = base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.LinearGradientMode;
			using LinearGradientBrush brush = new LinearGradientBrush(base.ClientRectangle, startColor2, endColor2, linearGradientMode2);
		...
		clientRectangle.Width -= ButtonGapLeft + ButtonClose.Width + ButtonGapRight;
		if (ShouldShowAutoHideButton)
		{
			clientRectangle.Width -= ButtonAutoHide.Width + ButtonGapBetween;
		}
		if (base.HasTabPageContextMenu)
		{
			clientRectangle.Width -= ButtonOptions.Width + ButtonGapBetween;
		}
		clientRectangle.Y += TextGapTop;
		clientRectangle.Height -= TextGapTop + TextGapBottom;
		TextRenderer.DrawText(foreColor: (!base.DockPane.IsActivated) ? base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.TextColor : base.DockPane.DockPanel.Theme.Skin.DockPaneStripSkin.ToolWindowGradient.ActiveCaptionGradient.TextColor, dc: g, text: base.DockPane.CaptionText, font: TextFont, bounds: DrawHelper.RtlTransform(this, clientRectangle), flags: TextFormat);
	}
	...
	private void SetButtonsPosition()
	{
		...
		int num4 = clientRectangle.X + clientRectangle.Width - 1 - ButtonGapRight - m_buttonClose.Width;
		int num5 = clientRectangle.Y + ButtonGapTop;
