...
internal class DockAreasEditor : UITypeEditor
{
	private class DockAreasEditorControl : UserControl
	{
		...
		public DockAreasEditorControl()
		{
			...
			base.Controls.AddRange(new Control[6] { checkBoxDockFill, checkBoxDockBottom, checkBoxDockTop, checkBoxDockRight, checkBoxDockLeft, checkBoxFloat });
	...
	public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
	{
		...
		((IWindowsFormsEditorService)provider.GetService(typeof(IWindowsFormsEditorService))).DropDownControl(m_ui);
