...
public class AssetTimelineSetChanged : EntityChangedEvent, IAssetTimelineSetChanged
{
	...
	public AssetTimelineSetChanged()
	{
		SetChangeType(EntityChangeType.ECT_ASSET_TIMELINE_SET_CHANGED);
	}
	...
	public virtual void SlotChanged(string pmSlotName, string pmTimelineName)
	{
		...
		m_changedSlots[pmSlotName] = pmTimelineName;
	}
	...
	public unsafe override void AddToChangeList(global::AssetObjects.EntityChangeList* changeList)
	{
		...
		if (m_changedSlots.Count == 0 && m_removedSlots.Count == 0)
		{
			if (m_changedSlots.Count == 0 && m_removedSlots.Count == 0)
			{
				...
				global::_003CModule_003E.Platform_002EAssertSilently((sbyte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_C_0040_0DJ_0040NAOHNLLL_0040m_changedSlots_003F9_003F_0024DOCount_003F5_003F_0024CB_003F_0024DN_003F50_003F5_003F_0024HM_003F_0024HM_003F5m__0040), (sbyte*)(&_0024ArrayType_0024_0024_0024BY0IAA_0040D2), (sbyte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref global::_003CModule_003E._003F_003F_C_0040_0IG_0040DGHDANOJ_0040C_003F3_003F2BuildAgent_003F2work_003F2acf3423fb2e59_0040), 46u);
			}
			return;
		}
		global::AssetObjects.AssetTimelineSetChanged* ptr = AddToChangeList_Checked_003CAssetObjects_003A_003AAssetTimelineSetChanged_003E(changeList);
		if (ptr == null)
		{
			return;
		}
			...
			do
			{
				...
				try
				{
					...
					try
					{
						...
						global::_003CModule_003E.AssetObjects_002EAssetTimelineSetChanged_002ESlotChanged(ptr, standardStringWrapper.Value, standardStringWrapper2.Value);
					}
					catch
					{
						//try-fault
		...
		do
		{
			...
			try
			{
				...
				global::_003CModule_003E.AssetObjects_002EAssetTimelineSetChanged_002ESlotRemoved(ptr, standardStringWrapper3.Value);
			}
			catch
			{
				//try-fault
