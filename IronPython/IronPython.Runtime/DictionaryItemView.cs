...
public sealed class DictionaryItemView : ICollection<object>, IEnumerable<object>, IEnumerable, ICodeFormattable
{
	...
	{
		if (!(item is PythonTuple { Count: 2 } pythonTuple) || !_dict.TryGetValue(pythonTuple[0], out var value))
		{
			return false;
		}
		return PythonOps.EqualRetBool(pythonTuple[1], value);
	}
