...
internal class PythonBinaryOperationBinder : BinaryOperationBinder, IPythonSite, IExpressionSerializable, ILightExceptionBinder
{
	...
	public override T BindDelegate<T>(CallSite<T> site, object[] args)
	{
		if (args[0] != null && CompilerHelpers.GetType(args[0]) == CompilerHelpers.GetType(args[1]))
		{
			...
			case ExpressionType.AddAssign:
				return BindAdd(site, args);
			case ExpressionType.And:
			case ExpressionType.AndAssign:
				return BindAnd(site, args);
			case ExpressionType.Or:
			case ExpressionType.OrAssign:
				return BindOr(site, args);
			case ExpressionType.Subtract:
			case ExpressionType.SubtractAssign:
				return BindSubtract(site, args);
			case ExpressionType.Equal:
				return BindEqual(site, args);
			case ExpressionType.NotEqual:
				return BindNotEqual(site, args);
			case ExpressionType.GreaterThan:
				return BindGreaterThan(site, args);
			case ExpressionType.LessThan:
				return BindLessThan(site, args);
			case ExpressionType.LessThanOrEqual:
				return BindLessThanOrEqual(site, args);
			case ExpressionType.GreaterThanOrEqual:
				return BindGreaterThanOrEqual(site, args);
			case ExpressionType.Multiply:
			case ExpressionType.MultiplyAssign:
				return BindMultiply(site, args);
			case ExpressionType.Divide:
			case ExpressionType.DivideAssign:
				return BindDivide(site, args);
			case ExpressionType.Modulo:
				return BindModulo(site, args);
			}
		}
		else
		{
			...
			case ExpressionType.Modulo:
				return BindModulo(site, args);
			case ExpressionType.Multiply:
				return BindMultiplyDifferentTypes(site, args);
			}
		}
	...
	private T BindAdd<T>(CallSite<T> site, object[] args) where T : class
	{
		...
		else if (type == typeof(List))
		{
			if (typeof(T) == typeof(Func<CallSite, object, object, object>))
			{
				if (base.Operation == ExpressionType.Add)
				{
	...
	{
		if (self != null && self.GetType() == typeof(List) && other != null && other.GetType() == typeof(int))
		{
	...
	{
		if (self != null && self.GetType() == typeof(string) && other != null && other.GetType() == typeof(int))
		{
	...
	{
		if (self != null && self.GetType() == typeof(PythonTuple) && other != null && other.GetType() == typeof(int))
		{
	...
	{
		if (self != null && self.GetType() == typeof(List) && other != null && other.GetType() == typeof(List))
		{
	...
	{
		if (self != null && self.GetType() == typeof(PythonTuple) && other != null && other.GetType() == typeof(PythonTuple))
		{
	...
	private object DoubleEqual(CallSite site, object self, object other)
	{
		if (self != null && self.GetType() == typeof(double) && other != null && other.GetType() == typeof(double))
		{
			if (!DoubleOps.Equals((double)self, (double)other))
			{
	...
	private object StringEqual(CallSite site, object self, object other)
	{
		if (self != null && self.GetType() == typeof(string) && other != null && other.GetType() == typeof(string))
		{
			if (!StringOps.Equals((string)self, (string)other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object StringEqual(CallSite site, string self, object other)
	{
		if (self != null && other != null && other.GetType() == typeof(string))
		{
			if (!StringOps.Equals(self, (string)other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object StringEqual(CallSite site, object self, string other)
	{
		if (self != null && self.GetType() == typeof(string) && other != null)
		{
			if (!StringOps.Equals((string)self, other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object DoubleNotEqual(CallSite site, object self, object other)
	{
		if (self != null && self.GetType() == typeof(double) && other != null && other.GetType() == typeof(double))
		{
			if (!DoubleOps.NotEquals((double)self, (double)other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object StringNotEqual(CallSite site, object self, object other)
	{
		if (self != null && self.GetType() == typeof(string) && other != null && other.GetType() == typeof(string))
		{
			if (!StringOps.NotEquals((string)self, (string)other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object StringNotEqual(CallSite site, string self, object other)
	{
		if (self != null && other != null && other.GetType() == typeof(string))
		{
			if (!StringOps.NotEquals(self, (string)other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	private object StringNotEqual(CallSite site, object self, string other)
	{
		if (self != null && self.GetType() == typeof(string) && other != null)
		{
			if (!StringOps.NotEquals((string)self, other))
			{
				return ScriptingRuntimeHelpers.False;
			}
			return ScriptingRuntimeHelpers.True;
	...
	{
		if (!(obj is PythonBinaryOperationBinder pythonBinaryOperationBinder))
		{
			return false;
		}
		if (pythonBinaryOperationBinder._context.Binder == _context.Binder)
		{
	...
	{
		return "PythonBinary " + base.Operation;
	}

	public Expression CreateExpression()
	{
		return Expression.Call(typeof(PythonOps).GetMethod("MakeBinaryOperationAction"), BindingHelpers.CreateBinderStateExpression(), Utils.Constant(base.Operation));
	}
	...
	public virtual CallSiteBinder GetLightExceptionBinder()
	{
		...
		{
			_lightThrowBinder = new LightThrowBinder(_context, base.Operation);
		}
