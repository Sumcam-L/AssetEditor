...
public class OrExpression : Expression
{
	...
	public override System.Linq.Expressions.Expression Reduce()
	{
		...
		return System.Linq.Expressions.Expression.Block(new ParameterExpression[1] { parameterExpression }, System.Linq.Expressions.Expression.Condition(base.GlobalParent.Convert(typeof(bool), ConversionResultKind.ExplicitCast, System.Linq.Expressions.Expression.Assign(parameterExpression, Utils.Convert(left, type))), parameterExpression, Utils.Convert(right, type)));
	}
