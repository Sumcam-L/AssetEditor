...
internal sealed class StaticTree
{
	...
	static StaticTree()
	{
		...
		static_l_desc = new StaticTree(static_ltree, ZLibUtil.extra_lbits, 257, 286, 15);
		static_d_desc = new StaticTree(static_dtree, ZLibUtil.extra_dbits, 0, 30, 15);
		static_bl_desc = new StaticTree(null, ZLibUtil.extra_blbits, 0, 19, 7);
	}
}
