...
internal static class NativeFunctions
{
	...
	{
		return LocalAlloc(64u, size);
	}

	public static IntPtr GetMemMoveAddress()
	{
		return Marshal.GetFunctionPointerForDelegate((Delegate)_moveMem);
	}

	public static IntPtr GetMemSetAddress()
	{
		return Marshal.GetFunctionPointerForDelegate((Delegate)_setMem);
	}
	...
	{
		IntPtr intPtr = dest.Add(length.ToInt32());
		IntPtr intPtr2 = dest;
		while (intPtr2 != intPtr)
		{
			Marshal.WriteByte(intPtr2, value);
			intPtr2 = new IntPtr(intPtr2.ToInt64() + 1);
		}
		return dest;
	}
