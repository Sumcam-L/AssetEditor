...
public class KnobSetSubgroupPropertyProxy : ICustomTypeDescriptor, IPropertyEditingContext
{
	private readonly IKnobSubgroup TargetKnobSubgroup;
	...
	public IEnumerable<PropertyDescriptor> PropertyDescriptors
	{
		get
		{
			foreach (IKnob knob in TargetKnobSubgroup.Knobs)
			{
	...
	public KnobSetSubgroupPropertyProxy(IKnobSubgroup knobSubgroup)
	{
		TargetKnobSubgroup = knobSubgroup;
	}
	...
	{
		return "KnobSubgroupProxy";
	}

	public string GetComponentName()
	{
		return TargetKnobSubgroup.SubgroupName;
	}
