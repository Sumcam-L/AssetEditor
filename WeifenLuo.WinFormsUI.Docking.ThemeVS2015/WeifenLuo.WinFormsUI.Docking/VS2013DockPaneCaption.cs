...
internal class VS2013DockPaneCaption : DockPaneCaptionBase
{
	...
	public VS2013DockPaneCaption(DockPane pane)
		: base(pane)
	{
		SuspendLayout();
	...
	protected override void OnPaint(PaintEventArgs e)
	{
		...
		if (sw.ElapsedMilliseconds > 1)
			System.Diagnostics.Trace.WriteLine($"[Paint] VS2013DockPaneCaption.OnPaint ({base.DockPane.CaptionText}): {sw.ElapsedMilliseconds}ms");
	}
	...
	private void SetButtonsPosition()
	{
		...
		int num3 = clientRectangle.X + clientRectangle.Width - 5 - m_buttonClose.Width;
		int num4 = clientRectangle.Y + 4;
