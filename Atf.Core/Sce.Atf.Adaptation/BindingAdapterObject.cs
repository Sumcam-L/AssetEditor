...
public class BindingAdapterObject : BindingAdapterObjectBase
{
	...
	private static readonly Dictionary<Type, BindingAdapterPropertyDescriptor[]> s_baseTypesLookup = new Dictionary<Type, BindingAdapterPropertyDescriptor[]>();
	...
	protected override PropertyDescriptorCollection GenerateDescriptors()
	{
		...
		foreach (object item in base.Adaptee.AsAll<object>())
		{
			...
			BindingAdapterObjectBase.MergeDescriptors(list, GetDescriptorsFromBaseTypes(type));
		}
